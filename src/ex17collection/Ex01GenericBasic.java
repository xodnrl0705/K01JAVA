...
//과일상자 : Object기반으로 모든 객체를 저장할수 있는 클래스
class FruitBox{
	Object item;
...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		상자1은 오렌지 전용박스이므로 다른과일(즉 객체)을 저장할수
		없다. 컴파일 에러가 발생하므로 실행자체가 불가능하다.
		...
		Orange orange3 = (Orange)fBox1.pulliOut();
		orange3.showInfo();
		
		FruitBox fBox2 = new FruitBox("당도가 30인 오렌지");
		Orange orange4 = (Orange)fBox2.pulliOut();//<-런타임에러(예외)발생
		orange4.showInfo();
