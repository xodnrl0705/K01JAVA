...
자바에서는 하나의 class만 public으로 선언하는것이 가능하다.
public으로 선언된 클래스에서 default클래스를 사용하는 형태로
제작되어야 한다.
 */
public class Calculator {
	...
	/*
	생성자메소드
		: 해당 클래스의 객체가 생성될때 덧셈, 뺄셈을
		위한 클래스의 객체도 동시에 생성된다.
	 */
	public Calculator() {
		adder = new Adder();
	...
	멤버메소드
		...
		각 연산을 위해 해당 default클래스의 멤버메소드를
		호출한 후 결과를 반환받는다.
	 */
	...
	정보은닉되어있는 멤버변수의 출력을 위해 getter() 메소드를 호출하고있다.
	 */
