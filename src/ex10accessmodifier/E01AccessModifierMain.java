...
접근지정자를 붙일수 있는곳
	...
	class명 앞에는 public, default만 붙일 수 있다.
 */
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		/*
		동일한 패키지에 선언된 클래스이므로 import없이객체생성 및
		접근이 가능하다.
		 */
		System.out.println("DefaultClass 객체 생성 및 접근");
		new DefaultClass1().myFunc();//객체생성과 동시에 맴버메소드 호출
		
		///////////////////////////////////////////////
		///////
		
		/*
		다른 패키지에 선언된 클래스이므로 객체생성을 위해서는 import가
		필요하다.
		패키지가 다른 경우 private, default 멤버에 접근을 허용하지
		않는다.
		 */
		...
		import도 불가능하므로 아예 사용할수 없는 클래스이다.
		 */
