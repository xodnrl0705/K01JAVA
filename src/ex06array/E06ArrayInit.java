...
public class E06ArrayInit {
	...
	public static void main(String[] args) {
		...
		/*
		1차원, 2차원배열은 크기가 지정된 경우에는 전체요소가
		0으로 초기화 된다.
		 */
		System.out.println("배열선언후 초기화 하지 않은 상태");
		int[] arr = new int[3];
		...
		2차원 배열도 마찬가지이나 다른점이 가장 큰 요소의 갯수에 의해 크기가
		결정되는것이다. 초기화가 진행된 경우 빈 부분은 0으로 채울수 없고
		null로 채워지게 된다.
		 */
		System.out.println("배열선언과 동시에 초기화 한 상태");
		int[] arrDim = {1, 2, 3};
