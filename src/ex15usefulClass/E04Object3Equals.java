...
class MyClass{
	...
	/*
	toSting() : 실제 저장된 데이터가 반환되도록 Object클래스로부터
		상속받아 오버라이딩한 메소드
	 */
	@Override
	...
	public boolean equals(Object obj) {
		/*
		매개변수로 전달된 객체를 Object로 받은후 MyClass의 인스턴스인지
		먼저 판단한다.
		 */
...
class Point {
	...
	/*
	객체1, 2의 x,y값을 동시에 비교해서 둘다 동일할때 같은 객체로
	판단하도록 오버라이딩 처리
	 */
	@Override
	public boolean equals(Object obj) {
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		/*
		아래 toString() 메소드는 굳이 호출하지 않아도 print()문이
		실행될때 자동으로 호출하므로, 아래 출력결과는 동일하다.
		 */
		System.out.println("pos1.toStiring()=>" + pos1.toString());
		System.out.println("pos2.toStiring()=>" + pos2.toString());
