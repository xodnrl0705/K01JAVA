...
public class Ex02PreDefineException {
	...
	public static void main(String[] args) {
		...
		try {
			...
			printStackTrace() : 예외가 발생할때의 에러메세지를
		...
		/*
		3] InputMismatchEception : 숫자를 입력해야 되는데
		문자열을 입력할때 발생되는 예외
		 */
		System.out.println("### InputMismatchEception ###");
		try {
			System.out.print("나이를 입력하세요:");
		...
		4] NullPointerException
			...
			발생되는 예외. 즉 참조변수만 생성되고, 참조할
			객체가 없는 상태에서 사용했을때 발생하게 된다.
		 */
	...
	/*
	String객체가 매개변수로 전달되면서 Object로 형변환되기 때문에.
	여기서는 상속관계가 확인되어 true를 반환한다.
	 */
