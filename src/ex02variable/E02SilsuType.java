...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		살슈 젌횽
		 ...
		 실수가 존재하기 때문)
		 - 따라서 long 과 float의 연산결과는 float형이된다.
		 */
		long long1 = 100;
		float float1 = 200;
		...
		/*
		float와 long 의 연산결과를 long으로 받고 싶다면
		...
		-소수점이 있는 데이터를 float에 대입하려면 접미사(f or F)사용한다.
		-형변환도 가능은 하지만 Java에서 권장하지 않는다.
		 */
		float f3 = 100;
		...
		float f5 = 3.14F;//자바에서는 접미사 사용을 권장하고 있음.
		...
		double d1 = 3.14;
		double d2 = f6 + d1; // float + double = double(큰 쪽으로 따라감)
