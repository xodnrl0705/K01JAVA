...
class NotebookComputer extends Computer{
	...
	앞에 다른 문장이 먼저오게되면 오류가 발생되므로 주의해야한다.
	 */
...
/*
테블릿 노트북 컴퓨터
	: 컴퓨터의 기본기능, 휴대이용에 펜으로 드로잉 할 수 있는
	기능까지 추가된 클래스
 */
class TabletNotebook extends NotebookComputer{
	...
	//테블릿 사용을 위해 배터리양 체크 및 등록된 펜인지 체크
